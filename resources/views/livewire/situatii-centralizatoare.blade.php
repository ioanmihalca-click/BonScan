                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                    <div class="flex justify-end space-x-3">
                                        ...
                                        <button wire:click="deleteSituatie({{ $situatie->id }})"
                                            onclick="return confirm('Sunteți sigur că doriți să ștergeți această situație?')"
                ...
                @foreach ($situatii as $situatie)
                    <div class="p-4 space-y-3">
                        ...
                        <div class="flex flex-wrap items-center justify-end gap-2 pt-2">
                            ...
                            <button wire:click="deleteSituatie({{ $situatie->id }})"
                                onclick="return confirm('Sunteți sigur că doriți să ștergeți această situație?')"
                                class="inline-flex items-center px-3 py-1.5 text-sm text-white bg-red-600 rounded-md hover:bg-red-700 focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
